// Small stroke-based inline SVG icons on a single 16px grid, replacing the
// unicode glyphs that rendered at inconsistent sizes/baselines across
// platforms. One icon size app-wide (16px) — callers may still override
// `size` for the rare exception, but the default is the shared metric.
...
export const IconAnchor = ({ size = 16 }: { size?: number }) => (
...
export const IconPrev = () => <Svg d={['m18 15-6-6-6 6']} />;
export const IconNext = () => <Svg d={['m6 9 6 6 6-6']} />;
